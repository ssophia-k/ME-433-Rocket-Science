...
def parabola(M, gamma, P, T, L, inviscid, lowest_per_shape):
    ...
    plt.tight_layout()
    plt.savefig("Midterm/results/viscous/parabolas.png")
    ...
    title = f"Lowest Viscous-Cost Parabola (spread param a={a_star:.3f}, number of points={num_star}, cost={cost_star_parabola:.4g})"
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig("Midterm/results/viscous/lowest_cost_parabola.png")
...
def triangle(M, gamma, P, T, L, inviscid, lowest_per_shape):
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig("Midterm/results/viscous/triangles.png")
    ...
    title = f"Lowest Viscous-Cost Triangle (inner half-angle={half_star:.3f}º, cost={cost_star_triangle:.4g})"
    wrapped_title = "\n".join(textwrap.wrap(title, width=50))
    plt.title(wrapped_title)
    plt.xlabel("x [m]")
    plt.ylabel("y [m]")
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig("Midterm/results/viscous/lowest_cost_triangle.png")
...
def triangular_wedge(M, gamma, P, T, L, inviscid, lowest_per_shape):
    ...
    ax.legend()
    plt.tight_layout()
    plt.savefig("Midterm/results/viscous/wedges.png")
    ...
    title = f"Lowest Viscous-Cost Triangular Wedge (inner half-angle={A_star:.3f}º, base height={BH_star:.3f} m, cost={cost_star_t_wedge:.4g})"
    wrapped_title = "\n".join(textwrap.wrap(title, width=50))
    plt.title(wrapped_title)
    plt.xlabel("x [m]")
    plt.ylabel("y [m]")
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig("Midterm/results/viscous/lowest_cost_wedge.png")
...
def trapezoid(M, gamma, P, T, L, inviscid, lowest_per_shape):
    ...
    ax.legend()
    plt.tight_layout()
    plt.savefig("Midterm/results/viscous/trapezoids.png")
    ...
    title = f"Lowest Viscous-Cost Trapezoid (height={H_star:.3f}, top length={T_star:.3f}, cost={cost_star_trapezoid:.4g})"
    wrapped_title = "\n".join(textwrap.wrap(title, width=50))
    plt.title(wrapped_title)
    plt.xlabel("x [m]")
    plt.ylabel("y [m]")
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig("Midterm/results/viscous/lowest_cost_trapezoid.png")
...
def power_series(M,gamma,P,T,L,inviscid,lowest_per_shape):
    ...
    plt.legend(title="Num Points", loc="best")
    plt.tight_layout()
    plt.savefig("Midterm/results/viscous/power_series.png")
    ...
    title = f"Lowest Viscous-Cost Power Series (base height={base_height_star:.3f}, number of points={num_star}, cost={cost_star_power:.4g})"
    wrapped_title = "\n".join(textwrap.wrap(title, width=50))
    plt.title(wrapped_title)
    plt.xlabel("x [m]")
    plt.ylabel("y [m]")
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig("Midterm/results/viscous/lowest_cost_power_series.png")
...
def diamond(M,gamma,P,T,L,inviscid,lowest_per_shape):
    ...
    ax.legend()
    plt.tight_layout()
    plt.savefig("Midterm/results/viscous/diamonds.png")
    ...
    title = f"Lowest Viscous-Cost Diamond (slope={S_star:.3f}, base height={BH_star:.3f} m, cost={cost_star_diamond:.4g})"
    wrapped_title = "\n".join(textwrap.wrap(title, width=50))
    plt.title(wrapped_title)
    plt.xlabel("x [m]")
    plt.ylabel("y [m]")
    ...
    plt.grid(True)
    plt.tight_layout()
    plt.savefig("Midterm/results/viscous/lowest_cost_diamond.png")
